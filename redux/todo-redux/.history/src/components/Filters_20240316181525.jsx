...
const Filters = () => {
    ...
    return (
        <div>
            <игеещт onClick={() => dispatch(setFilter('all'))} style={{ color:
            activeFilter === 'all' ? 'red' : 'grey'}}>all</и>

            <игеещт onClick={() => dispatch(setFilter('active'))} style={{ color:
            activeFilter === 'active' ? 'red' : 'grey'}}>active</и>

            <игеещт onClick={() => dispatch(setFilter('completed'))} style={{ color:
