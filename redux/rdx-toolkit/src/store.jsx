...
// заметка, мы не должны возвращать(return) значение если мы мутируем стейт
// если мы создаъм новый стейт сами(filter, map) то мы должны его вернуть
...
// 2-й вариант (консоль разработчика пишет, что не поддерживается)
